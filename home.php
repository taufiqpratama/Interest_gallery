...
<body>
    ...
    <section class="mt-4 mb-5">
        ...
        if(isset($_GET['kategoriid'])){
            ...
            WHERE foto.userid='$userid' AND foto.kategoriid='$kategoriid'");
            ...
            <?php while($data = mysqli_fetch_assoc($query)){?>
                ...
                <div class="card card-pin"  style="width: 18rem;">
                    ...
                    <div class="card-footer">
                        ...
                        <p class="card-text"><?php echo $data['namalengkap'] ?></p>
                        ...
                        <?php $kome = mysqli_query($conn, "SELECT * FROM komentar WHERE fotoid='$fotoid'");
                            echo mysqli_num_rows($kome) . ' Komentar';?></a>
                    </div>
                </div>
              </div>
    <?php   }} ?>
        ...
        <div class="col-md-3 mt-2">
                <div class="card card-pin"  style="width: 18rem;">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="detail.php?fotoid=<?php echo $data['fotoid']?>"><i class="fa-regular fa-comment"></i>
                        <?php $kome = mysqli_query($conn, "SELECT * FROM komentar WHERE fotoid='$fotoid'");
                            echo mysqli_num_rows($kome) . ' Komentar';?></a>
                    </div>
                  </div>
