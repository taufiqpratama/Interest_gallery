            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    if (isset($_GET['fotoid'])) { ?>
                        ...
                        $query = mysqli_query($conn, "SELECT * FROM foto INNER JOIN user 
                        ON foto.userid = user.userid INNER JOIN album ON foto.albumid = album.albumid 
                            ...
                            <div class="col-md-7">
                                <article class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php echo "<img src='assets/img/" . $row['namafoto_pro'] . "
                                        ...
                                        if (mysqli_num_rows($ceksuka) == 1) { ?>
                                            <a href="proses_like.php?fotoid=<?php echo $row['fotoid'] ?>" type="submit"
                                                name="batalsuka">
                                                <i class="fa fa-heart"></i></a>
                                        <?php } else { ?>
                                            <a href="proses_like.php?fotoid=<?php echo $row['fotoid'] ?>" type="submit" name="suka">
                                        ...
                                        while ($komentar_row = mysqli_fetch_array($komentar_query)) {
                                            ...
                                            <article class="card bg-light">
                                                <div class="d-flex align-items-center">
                                                    <?php echo "<img src='assets/img/" . $komentar_row['namafoto_pro'] .
                                                     "' class='rounded-circle me-2' width='40' height='40' />"; ?>
                                                    <div>
                                                        <a
                                                            class="fw-bold text-primary mb-1">
                                                            <?php echo $komentar_row['namalengkap'] ?></a>
                                                        <span
                                                            class="ms-3 small text-muted">
                                                            <?php echo $komentar_row['tanggalkomentar'] ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <footer class="card-footer bg-white border-0 py-1 px-3">
                                                    <form action="proses_komentar.php" method="POST">
                                                        ...
                                                        <input type="hidden" name="komentarid"
                                                            value="<?php echo $komentar_row['komentarid'] ?>">
                                                        <?php
                                                        ...
                                                        if ($currentUserID === $commentUserID) {
                                                             ...
                                                             text-decoration-none ps-0" data-bs-toggle="modal"
                                                                    data-bs-target="#edit' . $komentar_row['komentarid'] . '">
                                                                    <i class="fa fa-edit fa-sm"></i>
                                                                </button>';
                                                            echo '<button type="submit" name="hapus" class="btn btn-link 
                                                            btn-sm text-decoration-none ps-0" onclick="return confirm
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="edit<?php echo $komentar_row['komentarid'] ?>"
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="proses_komentar.php" method="POST">
                                                                    <input type="hidden" name="fotoid"
                                                                        value="<?php echo $row['fotoid'] ?>">
                                                                    <input type="hidden" name="komentarid"
                                                                        value="<?php echo $komentar_row['komentarid'] ?>">
                                                                    <label class="form-label">Komentar</label>
                                                                    <input type="text" class="form-control" name="isikomentar"
                                                                        value="<?php echo $komentar_row['isikomentar'] ?>">
                                                            </div>
