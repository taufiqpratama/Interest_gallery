...
<body>
	...
	<main role="main">
		...
		<div class="container-fluid mt-2">
			<div class="jumbotron jumbotron-fluid bg-gray position-relative">
				<!-- Icon Edit -->
				<div class="float-right top-0 end-0">
					<button type="button" class="btn btn-link btn-sm text-decoration-none ps-0" data-bs-toggle="modal"
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-md-3">
							<img src="assets/img/<?php echo $data['namafoto_pro'] ?>" class="rounded-circle mt-2"
								width="200">
						</div>
						<div class="col-md-9">
		...
		<!-- Modal -->
		<div class="modal fade" id="edit<?php echo $data['userid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
			aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h1 class="modal-title fs-5" id="exampleModalLabel">Edit Data Bio</h1>
					</div>
					<div class="modal-body">
						<form action="aksi_register.php" method="POST" enctype="multipart/form-data">
							<input type="hidden" name="userid" value="<?php echo $data['userid'] ?>">
							<label class="form-label">Bio</label>
							<textarea class="form-control" name="alamat"><?php echo $data['bio'] ?></textarea>
							<label class="form-label">Foto Bio</label>
							<div class="row">
								<div class="col-md-4">
									<img src="assets/img/<?php echo $data['foto_bio'] ?>" width="100">
								</div>
								<div class="col-md-8">
									<label class="form-label">Ganti Foto</label>
									<input type="file" class="form-control" name="foto_bio">
								</div>
							</div>
